...
public class SampleData {
    ...
    public static List<LogicTable> getLogic() {
        ...
        logic.add(new LogicTable(1, 1, -1, 2, "", -1, 2));
        logic.add(new LogicTable(2, 2, -1, 3, "", -1, 2));
        logic.add(new LogicTable(3, 3, -1, 4, "", -1, 2));
        logic.add(new LogicTable(4, 4, 12, 5, "NEXT", -1, 2));
        logic.add(new LogicTable(5, 4, -1, 6, "", -1, 2));
        logic.add(new LogicTable(6, 5, -1, 6, "", -1, 2));
        logic.add(new LogicTable(7, 6,  -1, 7, "AND", 1, 2));
        logic.add(new LogicTable(8, 6, -1, 8, "", -1, 2));
        logic.add(new LogicTable(9, 7, -1, 8, "", -1, 2));
        logic.add(new LogicTable(10, 8, -1, 9, "", -1, 2));
        logic.add(new LogicTable(11, 9, -1, 10, "OR", 2, 2));
        logic.add(new LogicTable(12, 9, -1, 11, "", -1, 2));
        logic.add(new LogicTable(13, 10, -1, 11, "", -1, 2));
        logic.add(new LogicTable(14, 11, -1, 12, "", -1, 2));
        logic.add(new LogicTable(15, 12, 28, 13, "NEXT", -1, 2));
        logic.add(new LogicTable(16, 12, 29, 14, "NEXT", -1, 2));
        logic.add(new LogicTable(17, 13, 30, 15, "NEXT", -1, 2));
        logic.add(new LogicTable(18, 13, -1, 17, "", -1, 2));
        logic.add(new LogicTable(19, 14, -1, 16, "AND", 3, 2));
        logic.add(new LogicTable(20, 14, -1, 17, "", -1, 2));
        logic.add(new LogicTable(21, 15, -1, 17, "", -1, 2));
        logic.add(new LogicTable(22, 16, -1, 17, "", -1, 2));
        logic.add(new LogicTable(23, 17, -1, 18, "", -1, 2));
        logic.add(new LogicTable(24, 18, -1, 19, "OR", 4, 2));
        logic.add(new LogicTable(25, 18, -1, 20, "", -1, 2));
        logic.add(new LogicTable(26, 19,  -1, 20, "", -1, 2));
        logic.add(new LogicTable(27, 20, -1, -1, "", -1, 2));
        logic.add(new LogicTable(28, 14, -1, 17, "AND", 5, 2));
